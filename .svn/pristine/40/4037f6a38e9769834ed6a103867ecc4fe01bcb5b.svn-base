				...
				<div class="container">
					<div class="row clearfix">
						...
						<section class="col-lg-9 col-md-9 col-sm-9">
							<h2 class="tt_uppercase color_dark m_bottom_25">请确认购买信息：</h2>
							<!--order info tables-->
							...
							<h2 class="tt_uppercase color_dark m_bottom_30">请选择收货地址</h2>
							 <select style="width: 100%;height: 40px;background:#e4e4e2;" name="sex">
									<option value="">${sessionScope.users.address }-${sessionScope.users.name }-${sessionScope.users.phone }</option>
									<option value="">山东省济南市曲水亭街998号3号楼1单元1010-老王-123423212121</option>
							</select>
							<br><br>
							<h2 class="tt_uppercase color_dark m_bottom_30">备注</h2>
